    ...
    return (
      <input
        ...
        className={cn(
          ...
          className?.includes("disable-ring") ? "" : "ring-offset-white focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
          className
        )}
        ref={ref}
        {...props}
